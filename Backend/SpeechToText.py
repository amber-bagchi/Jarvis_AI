...
# Replace the language setting in the html code with the input language from the enviroment variable
...
#Intialize the Chrome WebDriver using the ChromeDriverManager.
service = Service(ChromeDriverManager().install())
driver = webdriver.Chrome(service=service, options=chrome_options)

# Define the path for temprorary files
...
if __name__ == "__main__":
    while True:
        ...
        # Continuously perform speech recognition and print the recignized text.
