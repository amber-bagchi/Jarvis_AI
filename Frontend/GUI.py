...
from PyQt5.QtGui import QIcon, QFont, QColor, QPainter, QMovie, QTextCharFormat, QPixmap, QTextBlockFormat, QTextCursor
...
Assistantname = env_var.get("AssistantName")
...
class ChatSection(QWidget):
    ...
    def toggle_icon(self, event=None):
        ...
        if self.toggled:
            ...
            self.load_icon(GraphicsDirectoryPath('mic.png'))
            MicButtonClosed()
